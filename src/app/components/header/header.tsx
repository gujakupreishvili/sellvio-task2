  ...
  return (
    ...
    >
      ...
      <div className="flex items-center bottom-[15px]  left-[29px] xl:left-[17px]  absolute gap-[42px] w-full justify-between" >
        ...
        <Button text="როგორ მუშაობს" icon={IoArrowDown} className="flex flex-row-reverse bg-[#0866FF1F] rounded-[33px] px-[15px] xl:px-[30px] py-[18px] items-center text-white  gap-[10px] midNext:text-[18px] text-[13px] font-manrope font-medium" />
        <Button text="აღმოაჩინე კამპანიები" icon={IoArrowDown} className="flex flex-row-reverse bg-[#0866FF1F] rounded-[33px] px-[15px] xl:px-[30px] py-[18px] items-center text-white  gap-[10px] midNext:text-[17px] text-[13px] font-manrope font-medium" />
        </div>
        <div className="flex items-center gap-[34px] mr-[6%] ">
          <p className="midNext:text-[20px] mid:text-[16.5px] text-[15px]  text-[#1E1E1E] font-manrope font-bold">დარეგისტრირდი როგორც:</p>
          <div className="flex items-center gap-[26px]">
          <Button  Img={user} text="შემქმნელი" className="flex   border-[#0000001F] border-[1px] justify-center items-center px-[28px] py-[10px] rounded-[8px] shadow-[0_0_7.3px_0_#0000001F] gap-[10px] xl:text-[18px] text-[14px] text-black font-manrope font-bold"/>
          <p className="text-[#1E1E1E] xl:text-[20px] text-[15px]font-manrope font-medium">ან</p>
          <Button  Img={company} text="ბიზნესი" className="flex   border-[#0000001F] border-[1px] justify-center items-center px-[42px] py-[10px] rounded-[8px] shadow-[0_0_7.3px_0_#0000001F] gap-[10px] xl:text-[18px] text-[14px] text-black font-manrope font-bold"/>
          </div>
        </div>
      </div>
    </div>
